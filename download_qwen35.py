...
# -*- coding: utf-8 -*-
"""
从 ModelScope 下载 Qwen3.5-7B-Chat 模型
"""
...
def download_model():
    ...
    print("=" * 60)
    print("Qwen3.5-7B-Chat 模型下载工具 (ModelScope)")
    print("=" * 60)
    ...
    try:
        ...
        print("\n请尝试:")
        print("1. 检查网络连接")
        print("2. 手动访问: https://www.modelscope.cn/models/Qwen/Qwen3.5-7B-Chat")
        return None
