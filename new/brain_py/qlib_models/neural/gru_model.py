"""
gru_model.py - Qlib GRU benchmark port.

Reference hyperparameters (Alpha158):
  d_feat=20, hidden_size=64, num_layers=2, dropout=0.0,
  lr=2e-4, batch_size=800, n_epochs=200, step_len=20
"""
...
class GRUModel(QlibBaseModel):
    """GRU model for sequential HFT features."""
    ...
    def build_model(self) -> Any:
        ...
        net = _GRUNet(d_feat, hidden_size, num_layers, dropout)
    ...
    def fit(self, x: np.ndarray, y: np.ndarray) -> Dict[str, float]:
        ...
        lr = self.config.extra.get("lr", 2e-4)
