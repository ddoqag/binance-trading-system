"""
lstm_model.py - Qlib LSTM benchmark port.

Reference hyperparameters (Alpha158):
  d_feat=20, hidden_size=64, num_layers=2, dropout=0.0,
  lr=1e-3, batch_size=800, n_epochs=200, step_len=20
"""
...
class LSTMModel(QlibBaseModel):
    """LSTM model for sequential HFT features."""
    ...
    def build_model(self) -> Any:
        ...
        net = _LSTMNet(d_feat, hidden_size, num_layers, dropout)
